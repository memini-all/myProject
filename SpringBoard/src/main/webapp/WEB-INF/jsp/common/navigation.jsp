	            ...
	            <ul class="nav navbar-top-links navbar-right">
	                ...
	                <li class="dropdown">
	                    ...
	                    <ul class="dropdown-menu dropdown-user">
	                        ...
	                        <li><a href="searchMember"><i class="fa fa-users fa-fw"></i></a></li>
	                        <li class="divider"></li>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="boardList"><i class="fa fa-files-o fa-fw"></i> </a>
                        </li>
                        <li>
                        ...
                        <c:if test='${sessionScope.userrole == "A"}'>
	                        ...
	                        <li>
	                            <a href="adBoardGroupList"><i class="fa fa-files-o fa-fw"></i> </a>
	                        </li>
	                        <li>
	                            <a href="#"><i class="fa fa-sitemap fa-fw"></i><span class="fa arrow"></span></a>
	                            <ul class="nav nav-second-level">
	                                <li>
	                                    <a href="adDepartment"></a>
	                                </li>
	                                <li>
	                                    <a href="adUser"></a>
	                                </li>
                             ...
                             <li>
                                 <a href="adCodeList"><i class="fa fa-gear fa-fw"></i> </a>
                             </li>
	                	</c:if>	        
                    </ul>
                </div>
