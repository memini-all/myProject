...
public class BoardController {
	...
	public String boardRead(@RequestParam("brdno") int brdno, @ModelAttribute("cri") SearchCriteria cri, Model model) throws Exception {
	...
	public String modifyForm(@RequestParam("brdno") int brdno, @ModelAttribute("cri") SearchCriteria cri, Model model) throws Exception {
	...
	public String boardRemove(@RequestParam("brdno") int brdno, @ModelAttribute("cri") SearchCriteria cri, RedirectAttributes rttr) throws Exception {
